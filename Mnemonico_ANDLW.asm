...
START:
    ...
    MOVLW B'00011000' ; Movemos un dato literal hacia el registro W
    ANDLW B'10101010' ; Hacemos el AND entre el dato que está en W con el dato literal introducido y se guarda en W
