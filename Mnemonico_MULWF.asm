...
; con el valor de un determinado registro, variable u operando 
; y almacenarlo en W o en la misma variable dependiendo de si pongamos 
; W o F en "D" a la derecha de la coma cuando usemos el mnemonico .
...
START:
    MOVLW .255; Movemos el mayor dato de 8 bits al registro W
    MOVWF variablePrueba; Movemos ese dato a variablePrueba
MUL:
    MOVLW .255;Movemos otra vez el dato literal maximo de 8 bits al registro W
    MULWF variablePrueba; Multiplicamos el valor de W con el valor de variablePrueba
